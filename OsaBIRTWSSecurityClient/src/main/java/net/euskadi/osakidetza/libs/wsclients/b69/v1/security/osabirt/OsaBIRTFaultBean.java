...
/**
 * <p>Clase Java para OsaBIRTFaultBean complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="OsaBIRTFaultBean">
 *   &lt;complexContent>
...
@XmlType(name = "OsaBIRTFaultBean", propOrder = {
    "message",
    "errorCode",
    "stackTrace"
})
public class OsaBIRTFaultBean {

    @XmlElement(required = true)
    protected String message;
    @XmlElement(required = true)
    protected String errorCode;
    @XmlElementRef(name = "stackTrace", type = JAXBElement.class)
